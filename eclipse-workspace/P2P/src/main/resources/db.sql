...
drop table p2po_product;
drop table p2po_brand;
drop table p2po_tag;
drop table p2po_category;
drop table p2po_shop;
drop table p2po_account_role;
drop table p2po_role;
drop table p2po_account;

create table p2po_account (
...
create table p2po_role (
    id smallint primary key identity(1,1),
    name nvarchar(50) not null unique
)

create table p2po_account_role (
    account bigint,
    role smallint,
...
create table p2po_tag (
    id bigint primary key identity(1,1),
    name nvarchar(10) not null unique,
)

create table p2po_brand (
    id int primary key identity(1,1),
    name nvarchar(50) not null unique,
    disable bit default 0
)

create table p2po_product (
    id bigint primary key identity(1,1),
...
--insert into p2po_account(username, password) values ('admin', '');
--insert into p2po_role (name) values ('ROLE_ADMIN');
--insert into p2po_role (name) values ('ROLE_VENDOR');
--insert into p2po_role (name) values ('ROLE_USER');
--insert into p2po_account_role (account, role) values (1, 1);
...
insert into p2po_account(username, password) values ('admin', '');
insert into p2po_account(username, password) values ('vendor', '');
insert into p2po_account(username, password) values ('user', '');
...
insert into p2po_account_role (account, role) values (1, 1);
insert into p2po_account_role (account, role) values (2, 2);
insert into p2po_account_role (account, role) values (3, 3);

-- product

insert into p2po_account(username, password) values ('vendor-1', '');
insert into p2po_account(username, password) values ('vendor-2', '');
insert into p2po_account(username, password) values ('vendor-3', '');
insert into p2po_account(username, password) values ('vendor-4', '');
insert into p2po_account(username, password) values ('vendor-5', '');
insert into p2po_account(username, password) values ('vendor-6', '');

insert into p2po_account_role (account, role) values (4, 2);
insert into p2po_account_role (account, role) values (5, 2);

insert into p2po_shop (id, name, status) values (4, 'Mobile Shop', 1);
insert into p2po_shop (id, name, status) values (5, 'shop-2', 1);
insert into p2po_shop (id, name, status) values (6, 'shop-3', 1);
insert into p2po_shop (id, name, status) values (7, 'shop-4', 1);
insert into p2po_shop (id, name, status) values (8, 'shop-5', 1);
insert into p2po_shop (id, name, status) values (9, 'shop-6', 1);

insert into p2po_category (name, img) values ('Smartphone', '/static/default.png');
insert into p2po_category (name, img) values ('Laptop', '/static/default.png');
insert into p2po_category (name, img) values ('TV', '/static/default.png');
insert into p2po_category (name, img) values ('Smartwatch', '/static/default.png');
insert into p2po_category (name, img) values ('Toy', '/static/default.png');
insert into p2po_category (name, img) values ('Car', '/static/default.png');
insert into p2po_category (name, img) values ('Moto', '/static/default.png');
insert into p2po_category (name, img) values ('Headphone', '/static/default.png');

insert into p2po_brand (name) values ('Dell');
insert into p2po_brand (name) values ('Asus');
insert into p2po_brand (name) values ('Apple');
insert into p2po_brand (name) values ('Samsung');
insert into p2po_brand (name) values ('Sony');
insert into p2po_brand (name) values ('Xiaomi');

insert into p2po_product (shop, name, price, img, category, brand, quantity, detail) values (4, 'Iphone 7', 1150, 'https://cdn.tgdd.vn/Products/Images/42/87839/iphone-7-plus-128gb-hh-400x400.jpg', 1, 6, 40, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas fermentum. laoreet turpis, nec sollicitudin dolor cursus at. Maecenas aliquet, dolor a faucibus efficitur, nisi tellus cursus urna, eget dictum lacus turpis.');
...
from p2po_product product
left join p2po_shop shop
on shop.id = product.shop
left join p2po_category category
on category.id = product.category
left join p2po_brand brand
on brand.id	= product.brand;

-- insert into p2po_log (log, type, author) values ('log', 'test', 'Loc');

insert into p2po_account(username, password) values ('user-1', '');
insert into p2po_account(username, password) values ('user-2', '');
insert into p2po_account(username, password) values ('user-3', '');
insert into p2po_account(username, password) values ('user-4', '');
insert into p2po_account(username, password) values ('user-5', '');
insert into p2po_account(username, password) values ('user-6', '');
insert into p2po_account(username, password) values ('user-7', '');
insert into p2po_account(username, password) values ('user-8', '');
insert into p2po_account(username, password) values ('user-9', '');

insert into p2po_account_role (account, role) values (10, 3);
insert into p2po_account_role (account, role) values (11, 3);
insert into p2po_account_role (account, role) values (12, 3);
insert into p2po_account_role (account, role) values (13, 3);
insert into p2po_account_role (account, role) values (14, 3);
insert into p2po_account_role (account, role) values (15, 3);
insert into p2po_account_role (account, role) values (16, 3);
insert into p2po_account_role (account, role) values (17, 3);
insert into p2po_account_role (account, role) values (18, 3);

-- init product in cart
insert into p2po_cart (account, product, quantity) values (3, 1, 1); -- 1000 * 1
insert into p2po_cart (account, product, quantity) values (3, 2, 3); -- 1500 * 3

--
-- init product in cart
insert into p2po_cart (account, product, quantity) values (6, 1, 2); -- 1000 * 1
insert into p2po_cart (account, product, quantity) values (6, 2, 2); -- 1500 * 3
*/
/*
insert into p2po_bill (account, address) values (3, 'HCM');
-- select scope_identity();
insert into p2po_bill_item (id, product, quantity) values (1, 1, 1);
insert into p2po_bill_item (id, product, quantity) values (1, 2, 3);
delete from p2po_cart where account = 3;
...
--select *
--from
--	(select p2po_bill_item.product, p2po_bill_item.quantity from p2po_bill_item where id = 1) cart_item
--join ( select * from  (values (1)) as temp_table(id_bill) )

select 1 as bill_id, p2po_bill_item.product, p2po_bill_item.quantity from p2po_bill_item where id = 1

-- 1 as bill_id
insert into p2po_bill_item (id, product, quantity) (select 1 as id, p2po_cart.product, p2po_cart.quantity from p2po_cart where p2po_cart.account = 1)
*/
